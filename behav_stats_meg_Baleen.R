behav_stats_meg_Baleen <-function(subjType){
...
fileName <- paste(filePath,'MEG_',subjType,'_Baleen_accuracy.df',sep="")
load(fileName)

outFile <- paste(filePath,'MEG_',subjType,'_Baleen_acc_stats.txt',sep="")
sink(outFile)
