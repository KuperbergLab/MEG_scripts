function sensor_erpWin2R_Baleen_acsc(subjGroup,listPrefix,t1,t2,condList)
...
outFile = strcat('/cluster/kuperberg/SemPrMM/MEG/results/sensor_level/R/acsc_',listPrefix, '.Baleen_All.',int2str(t1),'-',int2str(t2),'.txt');
