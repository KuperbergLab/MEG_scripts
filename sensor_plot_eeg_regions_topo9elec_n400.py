...
##to add
#This script creates ERP plot with only C1, CZ, C2, CP1, CPZ, CP2, P1, PZ, P2 electrodes in the plot. You can plot two conditions at a time. 
...
#hemList = ['left','right']
channelList = ['C1', 'CZ', 'C2', 'CP1', 'CPZ', 'CP2', 'P1', 'PZ', 'P2']
...
outFile = results_path + args.prefix1 + '-' + args.prefix2 + '-' + str(args.set1)+'-'+str(args.set2)+'_topo9elec_n400'+ '.png'
pl.savefig(outFile)
