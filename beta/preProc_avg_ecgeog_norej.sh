...
foreach proj ( 'projon' 'projoff') ## Do not change the order. 
	...
	python /cluster/kuperberg/SemPrMM/MEG/scripts/makeAveFiles_ecgeog_norej.py $1 $proj >>& $log
...
#  	mne_process_raw \
#  	--raw ../$1_Blink_raw.fif \
#  	--ave ../ave/$1_Blink_ecgeog_norej.ave \
#  	--$proj --lowpass 20 >>& $log
#  
#  	mne_process_raw \
#  	--raw ../$1_ATLLoc_ssp_raw.fif \
#  	--ave ../ave/$1_ATLLoc_ecgeog_norej.ave \
...
#  	--gave $1_MaskedMM_All_ecgeog_norej-ave.fif \
#  	--$proj --lowpass 20 >>& $log
#  
#  	mne_process_raw \
...
#  	--gave $1_BaleenLP_All_ecgeog_norej-ave.fif \
#  	--$proj --lowpass 20 >>& $log
	...
	--gave $1_BaleenHP_All_ecgeog1_norej-ave.fif \
	--$proj --lowpass 20 >>& $log
...
# 			--gave $1_AXCPT_All_ecgeog_norej-ave.fif \
# 			--$proj --lowpass 20 >>& $log
# 		else
# 			mne_process_raw \
# 			--raw ../$1_AXCPTRun1_ssp_raw.fif \
...
# 	endif
    ...
    if ( $proj == 'projon' ) then
	        ...
	        python /cluster/kuperberg/SemPrMM/MEG/scripts/rej_rej2eve_projon_ecgeog_norej.py $1 >>& $log
	        echo "done" >>& $log
    endif  
