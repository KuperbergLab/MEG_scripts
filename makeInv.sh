...
####EEG cap stays in place, so only one for whole experiment
	...
	if ( $t == 'meg') then
		 mne_do_inverse_operator --fwd $1_ATLLoc-ave-7-$t-fwd.fif --depth --loose .2 --$t --senscov $1_AllTar-cov.fif 
		 mne_do_inverse_operator --fwd $1_MaskedMM_All-ave-7-$t-fwd.fif --depth --loose .2 --$t --senscov $1_AllTar-cov.fif
		 mne_do_inverse_operator --fwd $1_BaleenLP_All-ave-7-$t-fwd.fif --depth --loose .2 --$t --senscov $1_AllTar-cov.fif
		 mne_do_inverse_operator --fwd $1_BaleenHP_All-ave-7-$t-fwd.fif --depth --loose .2 --$t --senscov $1_AllTar-cov.fif
		...
		mne_do_inverse_operator --fwd $1_ATLLoc-ave-7-$t-fwd.fif --depth --loose .2 --$t --senscov $1_AllTar-cov.fif --inv $1_ATLLoc-ave-7-$t-$t-inv.fif
		 mne_do_inverse_operator --fwd $1_MaskedMM_All-ave-7-$t-fwd.fif --depth --loose .2 --$t --senscov $1_AllTar-cov.fif --inv $1_MaskedMM-ave-7-$t-$t-inv.fif
		 mne_do_inverse_operator --fwd $1_BaleenLP_All-ave-7-$t-fwd.fif --depth --loose .2 --$t --senscov $1_AllTar-cov.fif --inv $1_BaleenLP-ave-7-$t-$t-inv.fif
		 mne_do_inverse_operator --fwd $1_BaleenHP_All-ave-7-$t-fwd.fif --depth --loose .2 --$t --senscov $1_AllTar-cov.fif --inv $1_BaleenHP-ave-7-$t-$t-inv.fif
		if ( -e $1_AXCPTRun1-ave.fif ) then
		 ...
		 mne_do_inverse_operator --fwd $1_ATLLoc-ave-7-$t-fwd.fif --depth --loose .2 --meg --eeg --senscov $1_AllTar-cov.fif 
		 mne_do_inverse_operator --fwd $1_MaskedMM_All-ave-7-$t-fwd.fif --depth --loose .2 --meg --eeg --senscov $1_AllTar-cov.fif
		 mne_do_inverse_operator --fwd $1_BaleenLP_All-ave-7-$t-fwd.fif --depth --loose .2 --meg --eeg --senscov $1_AllTar-cov.fif
		 mne_do_inverse_operator --fwd $1_BaleenHP_All-ave-7-$t-fwd.fif --depth --loose .2  --meg --eeg --senscov $1_AllTar-cov.fif
		if ( -e $1_AXCPTRun1-ave.fif ) then
